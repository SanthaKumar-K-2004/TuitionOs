...
# This is a temporary workaround until GRADLE-2359 is fixed.
...
#     temporary variables to preserve quoting and prevent expansion.
#   * Put user-specified options at the end, so they take precedence.
set -- \
